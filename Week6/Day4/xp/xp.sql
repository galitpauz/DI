...
-- Write a query to get the number of employees working in the company.//limited the 2 decimal places
...
SELECT first_name AS "First Name", last_name AS "Last Name",length(first_name ||''|| last_name) FROM employees;
...
FULL OUTER JOIN jobs ON employees.job_id= jobs.job_id
...
OR last_name ='Blake' OR last_name ='Scott' OR last_name ='King' OR last_name ='Ford'
